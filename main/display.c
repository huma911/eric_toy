...
#define LCD_H_RES                   (160)   //number of horizontal pixels
#define LCD_V_RES                   (128)   //number of vertical pixels
...
// Using SPI2 in the project
#define LCD_HOST  SPI2_HOST
#define LCD_DRAW_BUFF_HEIGHT    (LCD_HEIGHT / 2)
...
static void lvgl_display_hardware_init(void)
{
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_st7735(lcd_io_handle, &panel_config, &lcd_panel_handle));
